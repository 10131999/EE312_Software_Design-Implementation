...
int main(void) {
    readInput("C:\\Users\\zanez\\CLionProjects\\Project7\\test1.txt");
    reset();
    readInput("C:\\Users\\zanez\\CLionProjects\\Project7\\test2.txt");
    reset();
    readInput("C:\\Users\\zanez\\CLionProjects\\Project7\\test3.txt");
    reset();
    return 0;
}
